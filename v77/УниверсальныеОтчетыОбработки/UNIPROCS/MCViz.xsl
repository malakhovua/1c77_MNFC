...
<!-- edited with XML Spy v3.0.7 (http://www.xmlspy.com) by Kravchenko (1C) -->
<!-- -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/TR/WD-xsl" xmlns:s="urn:schemas-microsoft-com:xml-data" xmlns:dt="urn:schemas-microsoft-com:datatypes">
	<xsl:template match="/">
	...
	<xsl:template match="s:Schema">
        ...
        table.tree TH.elements { background-color: darkblue; }
        table.tree TH.attributes { background-color: darkred; }
        table.tree TH A {color:white}
        ...
        table.tree TD.nobord { border: 0px; }
        table.tree TD.cycle {
        ...
        .ref-content { font-size:smaller; margin-left:2em; margin-bottom:.3em; }
			...
			<BODY>
				<H1>
      XML Schema<xsl:if test="@name">: <xsl:value-of select="@name"/>
					</xsl:if>
				</H1>
				<DIV class="toc">
            ...
            Исходный текст схемы</A>
						</LI>
						<LI>
							<A href="#reference">Описание атрибутов схемы</A>
						</LI>
						<LI>
							<A href="#datatypes">Описание типов данных</A>
						</LI>
					</UL>
                                        <xsl:eval no-entities="t">createElementTree(this)</xsl:eval>
					<p>Данная схема описывает следующие элементы и атрибуты:</p>
					<table class="list">
						<TR>
							<TH class="elements">
							...
							<TH class="attributes">
								<A href="#Attributes">Специфичные для элементов атрибуты</A>
							</TH>
						</TR>
						<TR>
							<TD class="elements">
              ...
              &lt;<A class="element-link">
										<xsl:attribute name="HREF">#ELEMENT_<xsl:value-of select="ancestor(s:ElementType)/@name"/></xsl:attribute>
										<xsl:value-of select="ancestor(s:ElementType)/@name"/>
									</A>
									<A class="attribute-link">
										<xsl:attribute name="HREF">#ELEMENTATTRIBUTE_<xsl:value-of select="ancestor(s:ElementType)/@name"/>_<xsl:value-of select="@name"/></xsl:attribute>
										<xsl:value-of select="@name"/>
									</A>&gt;
              <BR/>
								</xsl:for-each>
					...
					<p>Принятые обозначения:</p>
					<UL>
						<LI>[] - необязательный</LI>
						<LI>[]* - ноль или более раз</LI>
        ...
        Исходный текст схемы</H2>
					<PRE>
						<xsl:eval>this.xml</xsl:eval>
					</PRE>
				</DIV>
				<H2 id="Reference">Schema Attributes Reference: </H2>
				<DIV class="ref-heading">
					<A name="model_open">open model</A>
				</DIV>
      ...
      the content model.  This is the default value.
				...
				<DIV class="ref-heading">
					<A name="model_closed" class="ReferenceHeading">closed model</A>
				</DIV>
				<DIV class="ref-content">
      ...
      Permits the elements to appear (or not appear) in any order.  This is the default.
				...
				<DIV class="ref-heading">
					<A name="datatype_bin.base64" class="ReferenceHeading">bin.base64 datatype</A>
				</DIV>
				<DIV class="ref-content">
      MIME-style Base64 encoded binary BLOB. 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_bin.hex" class="ReferenceHeading">bin.hex datatype</A>
				</DIV>
				<DIV class="ref-content">
      Hexadecimal digits representing octets. 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_boolean" class="ReferenceHeading">boolean datatype</A>
				</DIV>
				<DIV class="ref-content">
      0 or 1, where 0 == "false" and 1 =="true". 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_char" class="ReferenceHeading">char datatype</A>
				</DIV>
				<DIV class="ref-content">
      String, one character long. 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_date" class="ReferenceHeading">date datatype</A>
				</DIV>
				<DIV class="ref-content">
      Date in a subset ISO 8601 format, without the time data. For example: "1994-11-05". 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_dateTime" class="ReferenceHeading">dateTime datatype</A>
				</DIV>
				<DIV class="ref-content">
      Date in a subset of ISO 8601 format, with optional time and no optional zone. Fractional seconds can be as precise as nanoseconds. For example, "1988-04-07T18:39:09". 
				...
				<DIV class="ref-heading">
					<A name="datatype_dateTime.tz" class="ReferenceHeading">dateTime.tz datatype</A>
				</DIV>
				<DIV class="ref-content">
      Date in a subset ISO 8601 format, with optional time and optional zone. Fractional seconds can be as precise as nanoseconds. For example: "1988-04-07T18:39:09-08:00". 
				...
				<DIV class="ref-heading">
					<A name="datatype_entity" class="ReferenceHeading">entity datatype</A>
				</DIV>
				<DIV class="ref-content">
      Represents the XML ENTITY type. 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_entities" class="ReferenceHeading">entities datatype</A>
				</DIV>
				<DIV class="ref-content">
      Represents the XML ENTITIES type. 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_enumeration" class="ReferenceHeading">enumeration datatype</A>
				</DIV>
				<DIV class="ref-content">
      Represents an enumerated type (supported on attributes only). 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_fixed.14.4" class="ReferenceHeading">fixed.14.4 datatype</A>
				</DIV>
				<DIV class="ref-content">
      Same as "number" but no more than 14 digits to the left of the decimal point, and no more than 4 to the right. 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_float" class="ReferenceHeading">float datatype</A>
				</DIV>
				<DIV class="ref-content">
      Real number, with no limit on digits; can potentially have a leading sign, fractional digits, and optionally an exponent. Punctuation as in U.S. English. Values range from 1.7976931348623157E+308 to 2.2250738585072014E-308. 
				...
				<DIV class="ref-heading">
					<A name="datatype_id" class="ReferenceHeading">id datatype</A>
				</DIV>
				<DIV class="ref-content">
      Represents the XML ID type. 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_idref" class="ReferenceHeading">idref datatype</A>
				</DIV>
				<DIV class="ref-content">
      Represents the XML IDREF type. 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_idrefs" class="ReferenceHeading">idrefs datatype</A>
				</DIV>
				<DIV class="ref-content">
      Represents the XML IDREFS type. 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_int" class="ReferenceHeading">int datatype</A>
				</DIV>
				<DIV class="ref-content">
      Number, with optional sign, no fractions, and no exponent. 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_nmtoken" class="ReferenceHeading">nmtoken datatype</A>
				</DIV>
				<DIV class="ref-content">
      Represents the XML NMTOKEN type. 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_nmtokens" class="ReferenceHeading">nmtokens datatype</A>
				</DIV>
				<DIV class="ref-content">
      Represents the XML NMTOKENS type. 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_notation" class="ReferenceHeading">notation datatype</A>
				</DIV>
				<DIV class="ref-content">
      Represents a NOTATION type. 
    </DIV>
				<DIV class="ref-heading">
					<A name="datatype_number" class="ReferenceHeading">number datatype</A>
				</DIV>
				<DIV class="ref-content">
      ...
      Integer represented in four bytes. A number, with optional sign, no fractions, no exponent. For example: "1, 703, -32768, 148343, -1000000000". 
				...
				<DIV class="ref-heading">
					<A name="datatype_r4" class="ReferenceHeading">r4 datatype</A>
				</DIV>
				<DIV class="ref-content">
      Real number, with seven digit precision; can potentially have a leading sign, fractional digits, and optionally an exponent. Punctuation as in U.S. English. Values range from 3.40282347E+38F to 1.17549435E-38F. 
				...
				<DIV class="ref-heading">
					<A name="datatype_r8" class="ReferenceHeading">r8</A>
				</DIV>
				<DIV class="ref-content">
    ...
    &lt;<A>
		...
		<table class="elements">
			<!-- Syntax -->
			<TR>
				<TD class="heading">синтаксис:</TD>
				<TD class="content">&lt;<SPAN class="syntax-element">
						<xsl:value-of select="@name"/>
					</SPAN>
					<xsl:if test="s:attribute">
									...
									<xsl:choose>
										<xsl:when test="ancestor(s:ElementType)//s:AttributeType[@name=context()/@type]">
											<xsl:for-each select="ancestor(s:ElementType)//s:AttributeType[@name=context()/@type]">
												<TD>&#160;<xsl:if test=".[not(@required) or not(@required='yes')]">[</xsl:if>
												</TD>
                        ...
                        = <xsl:choose>
                          ...
                          <SPAN class="syntax-constant">
																<xsl:for-each select="@dt:values">
																	<xsl:eval no-entities="t">formatEnum(this, this.selectSingleNode("../@default"));</xsl:eval>
																</xsl:for-each>
															</SPAN>
														</xsl:when>
														<xsl:when test="@dt:type">
															<A class="datatype-link">
																<xsl:attribute name="href">#datatype_<xsl:value-of select="@dt:type"/></xsl:attribute>
									...
									<xsl:when test="@dt:type">
										<xsl:for-each select="@dt:type">
											<TR>
												...
												<TD colspan="2">
													<A class="datatype-link">
														<xsl:attribute name="href">#datatype_<xsl:value-of select="."/></xsl:attribute>
														<xsl:value-of select="."/>
													</A> datatype</TD>
											</TR>
										</xsl:for-each>
										...
										<TR>
											...
											<TD class="syntax-order">
												<A class="reference-link">
													<xsl:attribute name="href">#order_<xsl:value-of select="@order"/></xsl:attribute>
													<xsl:value-of select="@order"/>
												</A>
												<xsl:if test=".[not(@order)]">
													<A class="reference-link" href="#order_many">(many)</A>
												</xsl:if>
											</TD>
											<TD>
												<table class="syntax-children">
								...
								<xsl:if test=".[not(@dt:type)][@content='mixed' or @content='textOnly']">
									<TR>
										...
										<TD colspan="2" class="note">
											состав <xsl:value-of select="@content"/></TD>
									</TR>
								</xsl:if>
								<xsl:if test=".[not(@dt:type)][not(@content)]">
									<TR>
										<TD>&#160;</TD>
										<TD colspan="2" class="note">состав mixed</TD>
									</TR>
								</xsl:if>
							</table>
          
          &lt;/<SPAN class="syntax-element">
								<xsl:value-of select="@name"/>
							</SPAN>&gt;
        </xsl:otherwise>
					</xsl:choose>
				...
				<TD class="content">
					<xsl:choose>
						...
						<xsl:when test="@content">
							<A class="reference-link">
								<xsl:attribute name="href">#content_<xsl:value-of select="@content"/></xsl:attribute>
								<xsl:value-of select="@content"/>
							</A>
						</xsl:when>
						<xsl:otherwise>
							<A class="reference-link" href="#content_mixed">mixed</A> (по умолчанию)
        </xsl:otherwise>
					</xsl:choose>
				</TD>
			</TR>
			<TR>
				<TD class="heading">порядок:</TD>
				<TD class="content">
					<xsl:choose>
						<xsl:when test="@dt:type">
						...
						<xsl:otherwise>
							<A class="reference-link" href="#order_many">many</A> (по умолчанию)
        </xsl:otherwise>
					</xsl:choose>
				</TD>
			</TR>
			<!-- Find the parents -->
			<TR>
				<TD class="heading">вышестоящие: </TD>
				<TD class="content">
					<xsl:choose>
				...
				<TD class="content">
					<xsl:choose>
						...
						<xsl:when test="@content[.='textOnly']">
							<SPAN class="note">Не разрешено наличие дочерних элементов, если состав - <A class="reference-link" href="#content_textOnly">textOnly</A>.</SPAN>
						</xsl:when>
						<xsl:when test=".//s:element">
			...
			<TR>
				...
				<TD class="content">
					<xsl:choose>
						...
						<xsl:when test="@model">
							<A class="reference-link">
								<xsl:attribute name="href">#model_<xsl:value-of select="@model"/></xsl:attribute>
								<xsl:value-of select="@model"/>
							</A>
						</xsl:when>
						<xsl:otherwise>
							<A class="reference-link" href="#model_open">open</A> (по умолчанию)
        </xsl:otherwise>
					</xsl:choose>
				</TD>
			</TR>
			<TR>
				<TD class="heading">исходный текст:</TD>
				<TD class="content">
					<PRE>
						<xsl:eval>suppressNS(this.xml)</xsl:eval>
					</PRE>
				</TD>
			</TR>
		</table>
	...
	<xsl:template match="s:AttributeType">
		...
		<DIV class="attributeType">
			<xsl:choose>
				<xsl:when test="..[@name]">
					<A>
						<xsl:attribute name="name">ELEMENTATTRIBUTE_<xsl:value-of select="../@name"/>_<xsl:value-of select="@name"/></xsl:attribute>
          &lt;<xsl:value-of select="../@name"/>
						<xsl:value-of select="@name"/>&gt;
        </A>
				</xsl:when>
      ...
      = <xsl:choose>
						<xsl:when test="@dt:type[.='enumeration']">
							<A class="datatype-link">
								<xsl:attribute name="href">#datatype_enumeration</xsl:attribute>enumeration</A>:
          <SPAN class="syntax-constant">
								<xsl:for-each select="@dt:values">
									<xsl:eval no-entities="t">formatEnum(this, this.selectSingleNode("../@default"));</xsl:eval>
								</xsl:for-each>
          ...
          no (по умолчанию)
			...
			<xsl:if test="@dt:type">
				<TR>
					<TD class="heading">тип данных:</TD>
					<TD class="content">
						<A class="datatype-link">
							<xsl:attribute name="href">#datatype_<xsl:value-of select="@dt:type"/></xsl:attribute>
							<xsl:value-of select="@dt:type"/>
			...
			<xsl:if test="@default">
				<TR>
					<TD class="heading">значение по умолчанию:</TD>
					<TD class="content">
						<B>
  ...
  function createAttrHTML(elem, attr)
  {
    var re = "" ;
    var en = attr.getAttribute("type") ;
    var hr = elem.getAttribute("name")+"_" ;
    re += "<br/><a class=\"attribute-link\" href=\"#ELEMENTATTRIBUTE_"+hr+en+"\">"+en+"</a>\n" ;
    return re ;
  }

  function createHTML(element, threadCont)
  {
    var re ;
    var en = element.getAttribute("name") ;
    var cnt ;
    if(threadCont.search(" "+en+" ") != -1) {
      re = "<tr><td class=\"cycle\">\n" ;
      re += "<a class=\"element-link\" href=\"#ELEMENT_"+en+"\">"+en+" </a><sup>Цикл</sup>\n" ;
      re += "</td>\n" ;
      re += "</tr>\n" ;
      return re ;
    } ;
    var re = "<tr><td class=\"nobord\"><table class=\"tree\"><td>\n" ;
    re += "<a class=\"element-link\" href=\"#ELEMENT_"+en+"\">"+en+"</a>\n" ;
    var attrNds = element.selectNodes("attribute") ; 
    for(cnt = 0 ; cnt < attrNds.length ; cnt++) {
      re += createAttrHTML(element, attrNds.item(cnt)) ;
    } ;
    re += "</td>\n" ;
    var els = element.selectNodes("element") ;
    if(els.length > 0) {
      re += "<td class=\"nobord\"><table class=\"tree\">\n" ;
      for(cnt = 0 ; cnt < els.length ; cnt++) {
        var el = els.item(cnt).getAttribute("type") ;
        el = element.selectSingleNode("../ElementType[@name=\""+el+"\"]") ;
        re += createHTML(el, threadCont+en+" ") ;
      } ;
      re += "</td></table>\n" ;
    } ;
    re += "</td></table></tr>\n" ;
  ...
  function createElementTree(elementSchema)
  {
    var re = "<table class=\"tree\">\n" ;
    var SelNds = elementSchema.selectNodes("ElementType") ;
    var cnt ;
    for(cnt = 0 ; cnt < SelNds.length ; cnt++) {
      var ET = SelNds.item(cnt) ;
      var ETn = ET.getAttribute("name") ;
      var SelParNds = elementSchema.selectNodes("ElementType/element[@type=\""+ETn+"\"]") ;
      if(SelParNds.length == 0) {
        re += createHTML(ET," ") ;
      } ;
    } ;
    re += "</table>" ;
